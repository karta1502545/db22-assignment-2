...
**Note**: If you encounter `LockAbortException` during your experiments after you implement **UpdateItemPriceTxn**. Please refer to [this article](https://shwu10.cs.nthu.edu.tw/courses/databases/2022-spring/faq/blob/master/Lock_Abort_Exception_in_Benchmark.md) in FAQ repository.
...
The name of the reports should be `[Year][Month][Day]-[Hour][Minute][Sec]-as2bench.csv`. E.g. `20220222-160720-as2bench.csv`
...
- Experiments
	...
	- Note: If you are using Windows, you should **turn off** disk write cache feature for correctness. You can find more information [here](https://shwu10.cs.nthu.edu.tw/courses/databases/2022-spring/faq/blob/master/Windows_Disk_Write_Cache.md).
...
1. Fork our [Assignment 2](https://shwu10.cs.nthu.edu.tw/courses/databases/2022-spring/db22-assignment-2) on GitLab
...
5. If you encounter any problem, take a look at our [FAQ repository](https://shwu10.cs.nthu.edu.tw/courses/databases/2022-spring/faq) first.


## Deadline

### Phase 1 
Submit your work before **2022/03/30 (Wed.) 23:59:59**.

### Phase 2 
Submit your work before **2022/04/06 (Wed.) 23:59:59**.
